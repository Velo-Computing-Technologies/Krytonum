/*
 * Minimal 8×8 bitmap font covering ASCII 0x20–0x7E (printable characters).
 * Each entry is 8 bytes (one byte per row, MSB = leftmost pixel).
 *
 * Derived from the classic IBM PC BIOS font — public domain.
 */
#ifndef FONT8X8_H
#define FONT8X8_H
...
/* font8x8[c - 0x20] gives the 8 row bytes for character c */
